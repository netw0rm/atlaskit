...
$BASEDIR/_scope_command.sh "$PKG" "../../node_modules/.bin/jsdoc2md --plugin dmd-bitbucket --template ../../docs/component-template.hbs --src ./src/index.js --helper ../../docs/helpers/*.js --partial ../../docs/partials/**/*.hbs --member-index-format list --name-format --no-gfm" | sed 1,3d >  "./packages/$PKG/docs/.tmp/README.md"
