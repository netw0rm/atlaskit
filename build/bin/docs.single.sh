...
$BASEDIR/_scope_command.sh "$PKG" "../../node_modules/.bin/jsdoc2md --plugin dmd-bitbucket --template ../../docs/component-template.hbs --src ./src/index.js" | sed 1,3d >  "./packages/$PKG/docs/.tmp/README.md"
