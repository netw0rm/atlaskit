...
FAILED_CI_FILE=$FAILED_CI_FILE HEAD_SHA=$HEAD_SHA CURRENT_BRANCH=$CURRENT_BRANCH BROWSERSTACK=1 `npm bin`/lerna exec --concurrency 2 -- ../../build/bin/test.sh --no-auto-watch
