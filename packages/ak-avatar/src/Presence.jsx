...
const onlinePresenceIcon = () => (<svg width="100%" height="100%" viewBox="0 0 8 8" xmlns="http://www.w3.org/2000/svg"><g id="User---presence" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd"><g id="Available" fill="#48CC8C"><circle id="Oval-3-Copy-7" cx="4" cy="4" r="4" /></g></g></svg>);

// TODO move this to ak-icon
// eslint-disable-next-line max-len, react/style-prop-object
const busyPresenceIcon = () => (<svg width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 8 8" style={{ enableBackground: 'new 0 0 8 8' }}><g id="User---presence"><g id="Busy-light"><circle id="Combined-Shape-Copy-5" fill="#ED5451" cx="4" cy="4" r="4" /><path id="Rectangle" fill="#FFFFFF" d="M3.3,1.9l2.8,2.8c0.2,0.2,0.2,0.5,0,0.7L5.4,6.1c-0.2,0.2-0.5,0.2-0.7,0L1.9,3.3c-0.2-0.2-0.2-0.5,0-0.7l0.7-0.7C2.8,1.7,3.1,1.7,3.3,1.9z" /></g></g></svg>);
