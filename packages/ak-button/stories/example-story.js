...
storiesOf(name, module)
  ...
  .add('an ak-button that removes itself when being clicked', () => {
  ...
  .addMonkeyTest('a ak-button with monkey testing', () => (
    // Use this to add a story that has fuzzy testing attached.
    <Component />
  ))
  .addMonitored('an ak-button with monitored performance', () => (
