...
storiesOf(name, module)
  ...
  .add('an ak-page that emits an action when it is clicked', () => (
    <Component id="myComponent" onClick={action('clicking the WebComponent')} />
  ))
  .add('an ak-page that removes itself when being clicked', () => {
  ...
  .addMonkeyTest('a ak-page with monkey testing', () => (
    // Use this to add a story that has fuzzy testing attached.
    <Component />
  ))
  .addMonitored('an ak-page with monitored performance', () => (
