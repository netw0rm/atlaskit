...
storiesOf(name, module)
  .add('a simple ak-validator', () => (
    <Component />
  ))
  .add('a simple ak-validator with a name', () => (
    <Component name="MyComponent" />
  ))
  .add('a simple ak-validator that uses an emitted event', () => (
    <Component
      name="MyComponent"
  ...
  .add('an ak-validator that emits an action when it is clicked', () => (
    <Component id="myComponent" onClick={action('clicking the WebComponent')} />
  ))
  .add('an ak-validator that removes itself when being clicked', () => {
  ...
  .addMonkeyTest('a ak-validator with monkey testing', () => (
    // Use this to add a story that has fuzzy testing attached.
    <Component />
  ))
  .addMonitored('an ak-validator with monitored performance', () => (
