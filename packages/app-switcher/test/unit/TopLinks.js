...
describe(name, () => {
  it('should return null if the user is anonymous', () => {
    const result = getTopLinks({}, true, false, true, true, true, true, true);

    expect(result).toBe(null);
  });

  it('should return null if none of the three links are enabled', () => {
    const result = getTopLinks({}, false, false, false, false, false, false, false);

    expect(result).toBe(null);
  });

  it('should return Home link item when it is enabled', () => {
    const result = getTopLinks({}, false, false, true, false, false, false, false, homeLink);
  ...
  it('should return People Profile Link Admin link item when it is enabled', () => {
    const result = getTopLinks(
      {}, false, false, false, false, false, true, false, null, null, peopleProfileLink
    );
  ...
  it('should return Invite Users Link item when it is enabled', () => {
    const result = getTopLinks(
      {}, false, false, false, false, false, false, true, null, null, null, inviteUsersLink
    );
