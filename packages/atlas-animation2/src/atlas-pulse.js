...
export default function(opts) {
  ...
  const animation = { //initial prop states, any prop that changes needs to be declared here
    ...
    opts: {
      ...
      points: [{'x':0,'y':0,'cp':[{'x':0.1,'y':0}]},{'x':0.22,'y':0.708,'cp':[{'x':0.12,'y':0.708},{'x':0.32,'y':0.708}]},{'x':0.509,'y':1.014,'cp':[{'x':0.341,'y':0.051},{'x':0.691,'y':-0.089}]},{'x':0.815,'y':0.699,'cp':[{'x':0.715,'y':0.699},{'x':0.915,'y':0.699}]},{'x':1,'y':0,'cp':[{'x':0.9,'y':0}]}]
      //points: [{'x':0,'y':0,'cp':[{'x':0.1,'y':0}]},{'x':0.477,'y':0.498,'cp':[{'x':0.303,'y':0.655},{'x':0.697,'y':0.296}]},{'x':1,'y':1,'cp':[{'x':0.9,'y':1}]}]
    }
  };
