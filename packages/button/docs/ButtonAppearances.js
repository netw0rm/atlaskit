...
const appearances = ['default', 'primary', 'link', 'subtle', 'subtle-link'];
...
const Cell = props => <div style={{ display: 'table-cell', padding: 4 }} {...props} />;
const Button = props => <Cell><Btn {...props} /></Cell>;
