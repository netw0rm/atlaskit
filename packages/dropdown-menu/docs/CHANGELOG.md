...
* feature; convert dropdown-menu and droplist to declarative API (issues closed: ak-2978) ([f6e0292](https://bitbucket.org/atlassian/atlaskit/commits/f6e0292))
## 3.4.2 (2017-07-27)
...
null refactored to meet new component conventions ([64510d9](https://bitbucket.org/atlassian/atlaskit/commits/64510d9))
null removed TypeScript ([d78988e](https://bitbucket.org/atlassian/atlaskit/commits/d78988e))
