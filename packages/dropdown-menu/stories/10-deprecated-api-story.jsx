...
import DropdownLoadItemsExample from './deprecated/examples/DropdownLoadItemsExample';
import DropdownLoadItemsExampleRaw from '!raw!./deprecated/examples/DropdownLoadItemsExample';
import DropdownWithTriggerOptions from './deprecated/DropdownWithTriggerOptions';
import DropdownWithTriggerOptionsRaw from '!raw!./deprecated/DropdownWithTriggerOptions';
import StatusDropdown from './deprecated/examples/StatusDropdown';
import StatusDropdownRaw from '!raw!./deprecated/examples/StatusDropdown';
import LongItemsDropdown from './deprecated/examples/LongItemsDropdown';
import LongItemsDropdownRaw from '!raw!./deprecated/examples/LongItemsDropdown';
import WideDropdown from './deprecated/examples/WideDropdown';
import WideDropdownRaw from '!raw!./deprecated/examples/WideDropdown';
...
import {
  ...
  itemsWithTooltips,
} from './deprecated/DropdownsDataDeprecated';
