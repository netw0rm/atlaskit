...
* bug fix; removes rowIndex prop from body render method ([9394455](https://bitbucket.org/atlassian/atlaskit/commits/9394455))

* bug fix; fixes react console error by adding key prop to TableRow in render method of Body ([c2e08cb](https://bitbucket.org/atlassian/atlaskit/commits/c2e08cb))
* feature; updates pagination dependency to 3.1.0 to get ellipsis when there are lots of pages (issues closed: ak-2689) ([391db73](https://bitbucket.org/atlassian/atlaskit/commits/391db73))

* bug fix; fixes '0' being displayed when rows prop is empty array ([8ce1453](https://bitbucket.org/atlassian/atlaskit/commits/8ce1453))



* bug fix; updates tests to check against Component not string ([a91743b](https://bitbucket.org/atlassian/atlaskit/commits/a91743b))
* breaking; Table will now render the Header by default, even if no rows are displayed ([bde2081](https://bitbucket.org/atlassian/atlaskit/commits/bde2081))
* breaking; updates description for dynamic-table stories ([bde2081](https://bitbucket.org/atlassian/atlaskit/commits/bde2081))

* bug fix; updates dynamic-table to have headerless emptyView ([aa87745](https://bitbucket.org/atlassian/atlaskit/commits/aa87745))


* bug fix; updates dynamic-table to always display table header ([ee35148](https://bitbucket.org/atlassian/atlaskit/commits/ee35148))
...
* breaking; DynamicTable export renamed to DynamicTableStateless, for consistency with other packages. ([3f52aff](https://bitbucket.org/atlassian/atlaskit/commits/3f52aff))
* breaking; refactor dynamic-table as part of styled-components refactor (issues closed: #ak-2385) ([3f52aff](https://bitbucket.org/atlassian/atlaskit/commits/3f52aff))
...
* bug fix; import DynamicTable from its own package ([61f6e86](https://bitbucket.org/atlassian/atlaskit/commits/61f6e86))



* bug fix; pR suggestions ([aee611e](https://bitbucket.org/atlassian/atlaskit/commits/aee611e))
