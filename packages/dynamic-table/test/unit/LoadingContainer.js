...
import { Container, ContentsContainer, SpinnerContainer } from '../../src/styled/LoadingContainer';
...
describe('LoadingContainer', () => {
  ...
  describe('when loading is enabled', () => {
    it('should render with a proper default values', () => {
      ...
      expect(wrapper.find(ContentsContainer).props().contentsOpacity).toBe(0.22);
