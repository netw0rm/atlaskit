...
export const StyledAvatar: any = styled.div`
  display: inline-flex;
  margin-left: -10px;
  & > div {
...
// tslint:disable-next-line:variable-name
export const Avatars: any = styled.div`
  position: fixed;
  top: 10px;
  right: 10px;
  z-index: 100;
...
export default class Collab extends PureComponent<Props, State> {
  render() {
    return (
      <Avatars>
...
/*import { MentionPicker as AkMentionPicker, MentionProvider } from '@atlaskit/avatar';
import * as React from 'react';
