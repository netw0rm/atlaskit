import { MarkType, NodeType as _NodeType, Schema, text } from '../../src';
...
function createMarkDef(schema: Schema<any, any>, name: string) {
...
const everHasMarks = (schema: Schema<any, any>, nodeName: string) => Object
  .keys(schema.nodes)
...
function createTextNodeDef(schema: Schema<any, any>, nodeName: string) {
  const definition: AnyObject = {
    properties: {
      text: {
        minLength: 1,
...
function createBlockNodeDef(schema: Schema<any, any>, nodeName: string) {
...
function createNodeDef(schema: Schema<any, any>, name: string) {
