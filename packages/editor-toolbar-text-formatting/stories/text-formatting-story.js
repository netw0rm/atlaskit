...
import TextFormattingComponent from '../src/index';
...
storiesOf('editor-toolbar-text-formatting', module)
  .add('Basic', () => (
    <TextFormatting />
  ))
          ...
          <div>
            <div>
              <TextFormatting
                ...
                ontoggle-bold={() => this.setState({ boldActive: !this.state.boldActive })}
                ontoggle-italic={() => this.setState({ italicActive: !this.state.italicActive })}
                ontoggle-underline={() => this.setState({ underlineActive: !this.state.underlineActive })}
                />
            </div>
            <p>
