...
export interface TrelloSchemaNodes {
  doc: NodeSpec;
  blockquote: NodeSpec;
  bulletList: NodeSpec;
...
export interface TrelloSchemaMarks {
  code: MarkSpec;
  link: MarkSpec;
  em: MarkSpec;
  strong: MarkSpec;
...
export interface TrelloSchema extends Schema<TrelloSchemaNodes, TrelloSchemaMarks> {}

export default createSchema({ nodes, marks, customNodeSpecs, customMarkSpecs }) as TrelloSchema;
