...
const EmojiPlaceholder = (props: Props) => {
  const { shortName, size = defaultEmojiHeight, showTooltip, representation } = props;
  ...
  const placeholderNode = (<span aria-label={shortName} className={classNames(classes)} style={style} />);
