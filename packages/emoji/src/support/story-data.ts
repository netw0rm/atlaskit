...
import { mockEmojiResourceFactory, MockEmojiResource, UsageClearEmojiResource } from './MockEmojiResource';
...
export const getUsageClearEmojiResource = (): UsageClearEmojiResource => new UsageClearEmojiResource(getEmojis());
