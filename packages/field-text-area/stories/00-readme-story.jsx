...
import FieldTextAreaOverviewExampleRaw from '!raw!./examples/FieldTextAreaOverview'; // eslint-disable-line import/no-duplicates
import FieldTextAreaOverviewExample from './examples/FieldTextAreaOverview'; // eslint-disable-line import/no-duplicates
...
storiesOf(name, module)
  .add('📖 Field Text readme', () => (
    <div>
      ...
      >
        <Code code={FieldTextAreaOverviewExampleRaw}>
          {FieldTextAreaOverviewExample}
        </Code>
        <Props component={FieldTextAreaStateless} descriptions={fieldTextPropDescriptions} />
      </Readme>
    </div>
  ));
