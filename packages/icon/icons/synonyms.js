...
module.exports = {
  ...
  'editor/text-style': ['text'],
  'editor/underline': ['font', 'text'],
  'editor/strikethrough': ['font', 'text'],
  'editor/quote': ['font', 'text'],
  'editor/undo': [],
  'editor/unlink': [],
  ...
  jira: [],
  'jira/blocker': ['priority', 'issue'],
  'jira/capture': [],
  'jira/critical': ['priority', 'issue'],
  'jira/failed-build-status': [],
  'jira/labs': [],
  'jira/major': ['priority', 'issue'],
  'jira/medium': ['priority', 'issue'],
  'jira/minor': ['priority', 'issue'],
  'jira/test-session': [],
  'jira/trivial': ['priority', 'issue'],
  ...
  public: ['permissions', 'globe', 'earth'],
