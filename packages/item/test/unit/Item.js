    ...
    describe('click', () => {
      ...
      describe('with drag and drop', () => {
        ...
        it('should call the dragHandle function even if disabled - dnd has its own disabled mechanism', () => {
          ...
          const wrapper = mount(<Item onClick={onClick} dnd={dnd} isDisabled />);
    ...
    describe('keydown', () => {
      ...
      describe('with drag and drop', () => {
        ...
        it('should execute the dragHandle function if provided', () => {
          const dnd = {
            dragHandleProps: {
              onKeyDown: jest.fn((event: KeyboardEvent) => event.preventDefault),
            },
            innerRef: () => { },
            draggableStyle: null,
          };
        ...
        it('should not call the original function if the item is dragging', () => {
          ...
          const onKeyDown = jest.fn();
          const wrapper = mount(<Item dnd={dnd} onKeyDown={onKeyDown} isDragging />);
