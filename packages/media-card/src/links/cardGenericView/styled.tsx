...
import { akColorN800, akColorN300, akColorN30, akColorY400, akBorderRadius } from '@atlaskit/util-shared-styles';
import { size, ellipsis, borderRadius, withAppearance, linkCardShadow, centerSelf, center, absolute } from '../../styles';
import { MediaImage, MediaImageProps } from '../../utils/mediaImage';
import ElementPlaceholder, {ElementPlaceholderProps} from '../../utils/elementPlaceholder';

// We need to do this in order to make TS find implicit interfaces
// https://github.com/Microsoft/TypeScript/issues/9944
export interface DummyInterface extends MediaImageProps, ElementPlaceholderProps {
