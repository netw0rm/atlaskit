...
describe('LinkCardGenericView', () => {
  ...
  it('should render placeholder items when isLoading="true"', () => {
    const card = mount(<LinkCardGenericView isLoading={true} title={title} linkUrl={linkUrl}/>);
  ...
  it('displays error when error prop is passed in', () => {
    const card = mount(<LinkCardGenericView title={title} linkUrl={linkUrl} errorMessage={errorMessage}/>);
