...
import {Title, Body, Icon} from '../../../../../src/utils/cardGenericViewSmall/infoView/styled';

describe('CardGenericViewSmall', () => {
  describe('InfoView', () => {

    it('should align to the bottom when title is undefined and isLoading=false', () => {
      const element = shallow(<InfoView title={undefined} subtitle="fobar" isLoading={false}/>);
    ...
    it('should align to the top when icon and subtitle is undefined and isLoading=false', () => {
      const element = shallow(<InfoView title="foobar" icon={undefined} subtitle={undefined} isLoading={false}/>);
    ...
    it('should not render the body when icon and subtitle are undefined and isLoading=false', () => {
      const element = shallow(<InfoView icon={undefined} subtitle={undefined} isLoading={false}/>);
