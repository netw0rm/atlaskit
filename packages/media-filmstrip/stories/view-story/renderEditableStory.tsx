  ...
  renderControls() {
    ...
    return (
      <div>
        ...
        <Flex>
          <Box>
            <Button onClick={this.handleGoToStart} isSelected={offset === minOffset}>Start</Button>
          </Box>
          <Box grow={1}>
            <Slider step={1} min={minOffset} max={maxOffset} value={offset} onChange={this.handleGoTo} />
          </Box>
          <Box>
            <Button onClick={this.handleGoToEnd} isSelected={offset === maxOffset}>End</Button>
          </Box>
        </Flex>
