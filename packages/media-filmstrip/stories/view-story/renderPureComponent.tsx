  ...
  render() {
    ...
    return (
      <div>
        ...
        <p>
          This story renders a filmstrip inside a React.PureComponent to assert that the state updates correctly. There once was a bug
          in filmstrip that resulted in the smart-card not displaying the arrows. See <a href="https://product-fabric.atlassian.net/browse/MSW-181">MSW-181</a>.
        </p>
