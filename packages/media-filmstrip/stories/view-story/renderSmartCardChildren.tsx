  ...
  render() {
    ...
    return (
      <div>
        ...
        <p>
          This story renders smart-card children to assert that they render OK inside the filmstrip. There once was a bug in filmstrip
          that resulted in the smart-card's text being invisible. See <a href="https://product-fabric.atlassian.net/browse/MSW-98">MSW-98</a>.
        </p>
