...
describe('MediaFileAttributes', () => {
  describe('fromFileItem', () => {
    ...
    it('should return binary url given no artifacts', () => {
      ...
      expect(attributes.src).toBe('https://filestore.io/file/basic-file/binary?max-age=3600');
    ...
    it('should return type video/mp4 given SD video', () => {
      ...
      expect(attributes.src).toBe('https://filestore.io/file/hd-file/artifact/video_640.mp4/binary?max-age=3600');
