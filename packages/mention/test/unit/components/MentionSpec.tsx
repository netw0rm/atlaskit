...
describe('<Mention />', () => {
  describe('Mention', () => {
    ...
    it('should dispatch lozenge.select analytics onClick-event', () => {
      ...
      expect(analyticsSpy.calledWith('atlassian.fabric.mention.lozenge.select', {accessLevel: 'CONTAINER', isSpecial: false})).to.equal(true);
    });
    ...
    it('should dispatch lozenge.hover analytics onMouseLeave-event', () => {
      ...
      expect(analyticsSpy.calledWith('atlassian.fabric.mention.lozenge.hover', {accessLevel: 'CONTAINER', isSpecial: false})).to.equal(true);
    });
