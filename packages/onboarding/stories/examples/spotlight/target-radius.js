      ...
      <div>
        <HighlightGroup>
          <SpotlightTarget name="small">
            <Highlight color="blue" radius={4}>Small</Highlight>
          </SpotlightTarget>
          <SpotlightTarget name="medium">
            <Highlight color="teal" radius={12}>Medium</Highlight>
          </SpotlightTarget>
          <SpotlightTarget name="large">
            <Highlight color="green" radius={24}>Large</Highlight>
          </SpotlightTarget>
        </HighlightGroup>

        <p style={{ marginBottom: '1em' }}>
          Rather than digging around in the DOM to find the element applying a
          border-radius, let&apos;s be explicit, define <Code>targetRadius</Code> on
          the Spotlight to round the cloned element.
        </p>
