...
describe('util/datetime.js', () => {
  describe('#addLeadingZeros()', () => {
    it('should prepend input with zeros until length `n` is met', () => {
      expect(addLeadingZeros(1, 2)).to.equal('01');
      expect(addLeadingZeros('4', 3)).to.equal('004');
      expect(addLeadingZeros('04', 3)).to.equal('004');
      expect(addLeadingZeros(-21, 5)).to.equal('00021');
    });
  });
