...
import { spacing } from '../../../page/src/internal/vars';
...
export const ProgressTrackerStageBar = styled.div`
    ...
    height: ${progressBarHeight}px;
    width: calc(${(props) =>
        props.percentageComplete}% /* width of step element */
        + ${(props) => props.percentageComplete}/100*${(props) => /* gradually add as stage is completed */
            halfGridSize + spacing[props.theme.spacing]}px); /* account for spacing and radius of marker */
