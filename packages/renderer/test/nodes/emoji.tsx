...
describe('Emoji', () => {
  ...
  it('should render fallback text if there is no emojiProvider prop', () => {
    const component = shallow(<Emoji emojiId={{ shortName: 'anything', fallback: 'fallback-text' }}/>);
  ...
  it('should render a EmojiWrapper component if emojiProvider supplied', () => {
    const component = shallow(<Emoji emojiId={{ shortName: 'anything', fallback: 'fallback-text' }} emojiProvider={emojiProvider}/>);
