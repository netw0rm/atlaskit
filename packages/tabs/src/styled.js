...
const labelColor = lockSelectedColor({ light: colors.N500, dark: colors.DN400 });
const activeLabelColor = lockSelectedColor({ light: colors.B500, dark: colors.B200 });
const focusLabelColor = lockSelectedColor({ light: colors.B100, dark: colors.B100 });
const hoverLabelColor = lockSelectedColor({ light: colors.B400, dark: colors.B75 });

const underlineColor = lockSelectedColor({ light: colors.N30, dark: colors.DN0 });
