    ...
    startTrial: {
      ...
      confirmTrialMessage: (
        <FormattedMessage
          ...
          tagName="p"
          defaultMessage="Once your trial finishes, billing will start.{br}Easily cancel at any time in Manage subscriptions.{br}We'll email your billing contact 10 days in advance."
          values={{ br: <br /> }}
        />
      ),
